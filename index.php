<?php
   ...
   try {
    $sql = "SELECT cars.id, cars.image, cars.title, cars.price, cars.consumption, categories.category_name FROM cars INNER JOIN categories ON categories.id = cars.cat_id";
    ...
    <div class="container-fluid py-5">
        ...
        foreach ($stmt->)fetchAll() as $row?>
            <tr>
                ...
                <td><img src="../img/<?php echo $car['image']; ?>" alt="<?php echo $car['title']; ?>" style="height: 100px; border-radius: 5px;"></td>
